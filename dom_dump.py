...
# For HCalTrigPrimDigiProducer.cc
...
process.histos = cms.EDAnalyzer("InspectTPs")
...
process.p = cms.Path( process.simHcalTriggerPrimitiveDigis + process.dump + process.histos )
